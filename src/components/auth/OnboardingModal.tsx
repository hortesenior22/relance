...
function EstudianteForm({
  ...
  const set =
    (k: keyof EstudianteState) => (e: ChangeEvent<HTMLInputElement>) =>
...
function EmpresaForm({
  ...
  const [form, setForm] = useState<EmpresaState>({
    nombre: "",
    cif: "",
    sector: "",
    ciudad: "",
...
function CentroForm({
  ...
  const [form, setForm] = useState<CentroState>({
    nombre: "",
    codigo_centro: "",
    tipo: "",
    ciudad: "",
            ...
            {ROLES.map((r) => (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <p
                    className={`text-sm font-semibold font-display ${role === r.id ? "text-white" : "text-gray-300"}`}
                  >
                    {r.label}
                  </p>
